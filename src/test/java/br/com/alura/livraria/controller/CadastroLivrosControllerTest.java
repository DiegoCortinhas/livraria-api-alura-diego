...
class CadastroLivrosControllerTest {
	...
	void deveriaCadastrarLivroComDadosCompletos() throws Exception {
		...
		String jsonLivro = "{\"titulo\":\"A culpa é das Estrelas\",\"dataLancamento\":\"2004-03-12\",\"numeroPaginas\":500,\"cadastro_autor_id\":"+idAutor+",\"usuario_id\":" +idUsuarioLogado +"}";
		String jsonLivroComAutor = "{\"titulo\":\"A culpa é das Estrelas\",\"dataLancamento\":\"2004-03-12\",\"numeroPaginas\":500, \"autor\":" + jsonAutor +"}";
